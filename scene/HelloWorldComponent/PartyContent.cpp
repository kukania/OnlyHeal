...
PartyContent::PartyContent(Tier t,Character *p) {
	...
	auto backGround = Sprite::create("images/party/bigwhite.png", Rect(Point(0,0),Size(460,190)));
	...
	img[2] = Sprite::create("images/party/tanker.png");
	img[2]->setPosition(tempS.width*0.75, tempS.height*0.75);
	img[3] = Sprite::create("images/party/melee.png");
	img[3]->setPosition(tempS.width*0.75, tempS.height*0.25);
	img[4] = Sprite::create("images/party/melee.png");
	img[4]->setPosition(tempS.width*0.625, tempS.height*0.5);
	img[5] = Sprite::create("images/party/range.png");
