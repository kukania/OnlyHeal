...
PartyLayer::PartyLayer() {
	...
	cancelBtn = ui::Button::create("images/party/partyOutBtn.png", "images/party/partyOutBtn.png", "images/party/partyOutBtn.png");
	...
	scrollView->setBackGroundImage("images/party/popUpFrame.png");
