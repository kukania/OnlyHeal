...
MonsterSkillFear::MonsterSkillFear():Skill(1000, "fear", 0, 0, 0, false) {
	factor = 0;
}
MonsterSkillFear::MonsterSkillFear(float myFloat, Tier T_input, SkillID now, string S_name, time_ms cool, time_s c):Skill(now,S_name,cool,c,10,true){
	myTier = T_input;
	this->myTier = myFloat;
}
